...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "transfercoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"TFC-Wallte-China-S1","118.244.217.212"},
    {"TFC-Wallte-China-S2","115.47.58.192"},
    {"TFC-Wallte-China-S3","118.244.216.67"},
    {"TFC-Wallte-China-S4","118.244.215.189"},
    {"TFC-Wallte-China-S5","118.244.215.190"},
    {"TFC-Wallte-USA-S1","162.243.217.162"},
    {"TFC-Wallte-USA-S2","162.243.136.198"},
    {"TFC-Wallte-EU-S1","146.185.134.15"},
    {"TFC-Wallte-Asia-S1","103.27.108.117"},
    {"TFC-Pool-China-S1","115.28.50.72"},
    {NULL,NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. transfercoin is probably already running."), addrBind.ToString().c_str());
        else
